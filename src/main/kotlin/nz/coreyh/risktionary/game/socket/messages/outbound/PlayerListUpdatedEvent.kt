...
/**
 * Event emitted when the list of players is updated, after a player
 * signals they are ready and the server responds with the current full
 * list of joined players.
 */
data class PlayerListUpdatedEvent(
    val players: List<GamePlayerView>,
) : GameEvent {
    override val type: GameEventType = GameEventType.PLAYER_LIST_UPDATED
}
